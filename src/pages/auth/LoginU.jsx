...
const LoginU = () => {
  ...
  const onSub = async (e) => {
    ...
    if (res.data.success) {
      localStorage.setItem('_pigion_access_user_login', true);

      Cookies.set('_pigion_access_user_tokon_', res.data.access_token, {
        expires: 1,
      });
          ...
          <div className="row">
            <div className="col-lg-5 col-md-7 col-12 mx-auto">
              <div className="card p-3">
                ...
                <h3 className="text-center pb-3">Hire With Pigion</h3>
                <br />
